...
public class Project {
    ...
    public Project(Integer id, Integer userId, String name, Integer paintingwayId, Integer categoryId, Integer labelId,
            ...
            Integer collections, project_category project_category,
            String state) {
        this.id = id;
        this.userId = userId;
        this.name = name;
    ...
    public project_category getProject_category() {
        return project_category;
    }

    public void setProject_category(project_category project_category) {
        this.project_category = project_category;
    }
}